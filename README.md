...
Подробная русская инструкция находится в [README.ru.md](README.ru.md). Описание исходной задачи и ограничений — в [PROJECT (web site analitic).md](PROJECT%20(web%20site%20analitic).md).
